...
class HepsiAdmin(admin.ModelAdmin):
    list_display = ("title", "youtube", "okunma_sayisi", "Hikaye_Turu", "seo_check", "hikayeyi_gor", "kisa", "uzun", "status", "yayin_tarihi", "olusturma_tarihi", "guncelleme_tarihi","small_banner","banner","aktif",)#"get_hikayeKategorisi", "get_masalKategorisi",
